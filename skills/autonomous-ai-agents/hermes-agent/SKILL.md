---
name: hermes-agent
description: "Configure, extend, audit, harden, or contribute to Hermes Agent and its VM environment."
version: 2.2.0
...
metadata:
  hermes:
    tags: [hermes, setup, configuration, multi-agent, spawning, cli, gateway, development, safety, autonomy, stability, cron-jobs, auditing]
...
## VM Safety, Autonomy, & Stability Auditing

For a copy of Justin's complete Safety & Autonomy Guidance, see `references/guidance.md` in this skill's folder.

Use these guidelines and checklists when auditing or adjusting the Hermes VM environment, configuring credentials/tool limits, debugging background cron-job failures, or ensuring alignment with Justin's "VM Safety & Autonomy Guidance."
