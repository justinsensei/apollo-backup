...
description: "Use when Justin asks to 'fill my inbox', 'sync my tasks', 'what am I missing in Todoist', or wants open actions from external sources (Slack, Gmail, Calendar, Obsidian daily notes) surfaced into his Todoist Inbox — without duplicating what's already there. Linear is excluded. Accepts an optional lookback window (default 48h)."
