...
def _resolve_account_paths():
    ...
    Reads GOOGLE_ACCOUNT env var. If set, returns per-account paths under
    ~/.hermes/google_tokens/<acct>.json. If unset, returns legacy single-token
    paths so non-account-aware callers keep working.
    """
    import os as _os
...
TOKEN_PATH, CLIENT_SECRET_PATH = _resolve_account_paths()
