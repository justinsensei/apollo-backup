...
- **Reference Template**: `templates/sync_reminders_to_obsidian.py` (a copy of this template is stored directly within this skill for replication or backup updates).
