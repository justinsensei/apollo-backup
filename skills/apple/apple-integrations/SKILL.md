...
## 2. Apple Reminders Sync (Disabled)

*Disabled per user request.* Apple Reminders scraping/syncing is permanently turned off. No Reminders are ingested into Obsidian or tracked.
