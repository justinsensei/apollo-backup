...
- id=19e94b964254c473 from='Justin Goff <justin@signlab.co>' subject='Fwd: Changelog: Team documents' snippet='Add a task to Todoist to remind me to check this out tomorrow ---------- Forwarded message ---------- From: Linear &lt;changelog@updates.lin'
```
...
✅ Changelog: Team documents → created 2026-06-04 Changelog - Team documents.md and added Todoist task (instruction: "Add a task to Todoist to remind me to check this out tomorrow")
