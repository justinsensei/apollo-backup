...
Unprocessed Readings found: 4
  - Inputs/Readings/The Great AI Double Standard.md
...
**Mode:** `since-last-run`
- **`last_run_at` before:** `2026-07-28T16:30:15-04:00`
- **`last_run_at` after:** `2026-07-28T17:00:29-04:00`
...
- **Phase 4 (Digest Inputs covered):** 1

---

### Files Written & Updated

#### Phase 1: Sources Extracted
- `Inputs/Sources/The Great AI Double Standard 20260728170029.md`
  *(Reading renamed to `Inputs/Readings/The Great AI Double Standard 2026-07-28.md`)*

#### Phase 2: Source Proposals
- `Inbox/Proposals/Proposal - The Great AI Double Standard 20260728170030.md`
  - Proposed Concept: `[[The AI distillation fair use parity 20260728170030]]`
  - Proposed Person: `[[Joan Westenberg 20260728170031]]`

#### Phase 4: Others Digest Proposals
- `Inbox/Proposals/Proposal - Inputs digest 2026-07-28 20260728170032.md`
  - Covered scrap: `[[Pair shape eval modes on main 20260728164254]]`
  - Proposed Concept: `[[Split topic enrichment from structural shape failures in creation evals 20260728170032]]`
